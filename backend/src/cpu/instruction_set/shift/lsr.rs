...
mod tests {
    use super::*;
    use crate::cpu::instruction_set::InstructionType::{ASL, LSR};
    ...
    fn asl_instruction_no_carry_positive_to_accumulator() {
        ...
        let instruction = Instruction {
            ...
            opcode: 0x4A,
            operand: Some(Operand::Value(0b00000010)),
            addressing_mode: AddressingMode::Accumulator,
            operation: InstructionSet::lsr,
        };
        ...
        assert_eq!(registers.accumulator, 0b00000001);
