...
impl<T: MemoryIndexer> InstructionSet<T> {
    pub(crate) fn cpy(
        ...
        let result = registers.y.wrapping_sub(operand_value);

        registers.set_flag(Flag::Carry, registers.y >= operand_value);
...
mod tests {
    use super::*;
    use crate::cpu::instruction_set::InstructionType::{AND, BIT, CLC, CPY, ORA};
    use crate::utils::testing::TestBus;

    #[test]
    fn cpy_instruction_carry() {
        // Arrange
