...
impl<T: MemoryIndexer> InstructionSet<T> {
    pub(crate) fn tay(
        ...
        registers.set_flag(Flag::Zero, registers.y == 0);
        registers.set_flag(Flag::Negative, is_negative(registers.y));
...
mod tests {
    use super::*;
    use crate::cpu::instruction_set::InstructionType::{AND, BIT, CLC, CLD, CLV, ORA, PHA, PHP, TAX, TAY};
    use crate::utils::testing::TestBus;

    #[test]
    fn tay_instruction_positive() {
        // Arrange
